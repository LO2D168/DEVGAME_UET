...
# SDL2_mixer_INCLUDE_DIR, where to find SDL.h
#
# This module responds to the the flag:
# SDL2_mixer_BUILDING_LIBRARY
# If this is defined, then no SDL2_mixermain will be linked in because
...
# OS X framework based version. (Other versions link to -lSDL2_mixermain which
...
# Set SDL2_mixer_LIBRARY_TEMP to point to your SDL2_mixer library, and configure again.
# Similarly, if you see an empty SDL2_mixerMAIN_LIBRARY, you should set this value
...
#
#
# $SDL2_mixerDIR is an environment variable that would
# correspond to the ./configure --prefix=$SDL2_mixerDIR
...
# Added a search for SDL2_mixermain which is needed by some platforms.
...
#
# Note that the header path has changed from SDL2_mixer/SDL.h to just SDL.h
# This needed to change because "proper" SDL convention
# is #include "SDL.h", not <SDL2_mixer/SDL.h>. This is done for portability
# reasons because not all systems place things in SDL2_mixer/ (see FreeBSD).
...
# It's total link flags should look like -lmingw32 -lSDL2_mixermain -lSDL2_mixer -mwindows
IF(MINGW)
